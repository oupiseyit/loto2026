<div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
            <h2 class="text-base font-bold" style="color:#DC143C;">Staff Accounts</h2>
        ...
        <button wire:click="openCreate('staff')" type="button"
                ...
                style="background-color:#DC143C;">+ Add Staff</button>
    </div>
    ...
    @else
        <p class="text-sm text-gray-400 text-center py-4">No staff accounts yet.</p>
    @endif
</div>
