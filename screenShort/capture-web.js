/**
 * Screenshot capture — WEB (Desktop)
 * HT ភ្នាក់ Lotto App
 *
 * Viewport: 1440 × 900
 * Output:   screenShort/web/{admin,master,staff}/<page>.png
 *
 * Usage:
...
(async () => {
    ...
    for (const config of ROLES) {
        console.log(`\n── WEB │ ${config.role.toUpperCase()} (${config.username}) ──`);
    ...
    await browser.close();
    console.log('\n✅ Web screenshots saved to screenShort/web/{admin,master,staff}/');
})();
